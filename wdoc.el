;;; wdoc.el --- hypertext authoring the WikiWay
...
;; install, put wdoc.el on you load-path, and add the following to your
;; .emacs file:

;; (require 'wdoc)

;; This will activate WdocMode for all files in `wdoc-directories' as soon
;; as they are opened.  This works by adding `wdoc-maybe' to
;; `find-file-hooks'.
